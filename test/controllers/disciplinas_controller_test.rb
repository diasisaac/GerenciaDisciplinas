...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference("Disciplina.count") do
      post disciplinas_url, params: { disciplina: { ano_letivo: @disciplina.ano_letivo, nome: @disciplina.nome, turma_id: @disciplina.turma_id } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { ano_letivo: @disciplina.ano_letivo, nome: @disciplina.nome, turma_id: @disciplina.turma_id } }
