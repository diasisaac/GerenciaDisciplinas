Feature: User
  ...
  Scenario: cadastro com campo login de tamanho incorreto
    Given Eu estou na pagina de cadastro
    And Eu preencho login com o email "Evd", a senha com "123456" e confirmacao de senha com "123456"
    When Eu clico em cadastrar
    Then Eu vejo a mensagem de erro "Email com tamanho de 5 a 20 caracteres"